...
const csrfToken = questionForm.elements.csrfmiddlewaretoken.value
...
questionForm.addEventListener('submit', async function (event) {
    ...
    formData.append('subject', questionForm.elements.subject.value)
    ...
    if (!response.ok || (outputData.blocks.length === 0)) {
        ...
        Toastify({
            text: "Pergunta criada com sucesso! Você será redirecionado em breve.",
            duration: 3000,
            close: true,
            gravity: "top",
            position: "center",
