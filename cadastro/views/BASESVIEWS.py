...
class PasswordChangeView(PasswordContextMixin, FormView):
    ...
    template_name = 'registrologin/password_change_form.html'
...
class PasswordResetView(PasswordContextMixin, FormView):
    ...
    subject_template_name = 'registrologin/password_reset_subject.txt'
    success_url = reverse_lazy('password_reset_done')
    template_name = 'EsqueciSenha.html'
    title = ('Alteração de senha')
...
class PasswordResetConfirmView(PasswordContextMixin, FormView):
    ...
    template_name = 'TrocarSenha.html'
...
class PasswordChangeDoneView(PasswordContextMixin, TemplateView):
    ...
    title = ('Alteração de senha com sucesso')
